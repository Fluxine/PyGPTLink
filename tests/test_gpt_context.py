...
class TestGPTContext(unittest.TestCase):
    ...
    def test_init(self):
        # White box testing here to make life easy, the details around tokenisation are too many to bother with.
        self.assertEqual(self.cut.token_encoding,
                         tiktoken.encoding_for_model("gpt-3.5-turbo-0613"))
    ...
    def test_context_persistence(self):
        self.cut.append_user_prompt("user1", "test1")
        self.cut.append_user_prompt("user2", "test2")
    ...
    def test_single_prompt(self):
        self.cut.append_user_prompt("User123", "User prompt content")
    ...
    def test_longer_history(self):
        self.cut.append_user_prompt("user1", "content1")
        self.cut.append_user_prompt("user2", "content2")
        self.cut.append_user_prompt("user3", "content3")
