...
def message_token_constants(model: str):
    if model in {
        "gpt-3.5-turbo-0125",
        "gpt-4-0314",
        "gpt-4-32k-0314",
...
def tool_token_constants(model):
...
def num_tokens_for_messages(messages: list[dict], model: str):
    try:
...
def num_tokens_for_tools(functions, model):
